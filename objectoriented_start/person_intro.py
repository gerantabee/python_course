# Classes define resuable objects and building blocks we can use to create applications
# You can encapsulate functionality, give it characteristics and even extend it as needed for different scenarios

# Define your class using the class keyword, followed by your classname
class Person:
    version = 2.5
